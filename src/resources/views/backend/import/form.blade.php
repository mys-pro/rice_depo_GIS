                                            ...
                                            @foreach (old('inputs') as $index => $val)
                                                <tr>
                                                    ...
                                                    <td data-title="Lúa" class="align-middle">
                                                        <select class="form-select import-rice use-select2"
                                                    ...
                                                    <td data-title="Đơn giá" class="align-middle tw-50">
                                                        <div class="input-group">
                                                            <input name="inputs[{{ $index }}][price]"
                                                                type="text"
                                                                class="form-control input-format import-price border-end-0 pe-0"
                                                                value="{{ $val['price'] }}">
                                                            <span
                                                                class="input-group-text bg-transparent border-start-0">VNĐ</span>
                                                        </div>
                                                    </td>
